<template>
  <div class="app-container">
      ...
      >
        <template #default="scope">
          ...
          <el-button
            ...
            >删除</el-button
          >
          <el-button link type="primary" icon="Delete" @click="handleLook(scope.row)"
            >查看</el-button
          >
          <el-button
            link
    ...
    <el-dialog :title="title" v-model="dialogVisible" width="1050px" @close="cancel()">
...
import { getAllProjects } from "@/api/nursing/NursingProject";
